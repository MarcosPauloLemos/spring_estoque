...
@Service
public class ProcessarPedidoEntrada extends ProcessarPedidoAbstract {

    protected ProcessarPedidoEntrada(EstoqueService estoqueService, PedidoEstoqueService pedidoEstoqueService) {
    ...
    public void movimentarEstoque(PedidoEstoque pedidoEstoque) {
        ...
        pedidoEstoque.getItens().forEach(item -> estoqueService.entradaEstoque(finalPedidoEstoque.getFilial(),
